...
namespace Poloniex.Net.Clients.ExchangeApi
{
    ...
    internal class PoloniexRestClientExchangeApiAccount : IPoloniexClientExchangeApiAccount
    {
        ...
        public Task<HttpResult<PoloniexAccountBalance[]>> GetAccountBalancesAsync(CancellationToken ct = default)
        {
        ...
        public Task<HttpResult<PoloniexAccountFee>> GetFeeRatesAsync(CancellationToken ct = default)
        {
        ...
        public Task<HttpResult<PoloniexWalletActivity>> GetWalletActivityAsync(DateTime startDate, DateTime endDate, PoloniexWalletActivityType? activityType = null, CancellationToken ct = default)
        {
        ...
        public Task<HttpResult<PoloniexAccountActivity[]>> GetAccountActivityAsync(DateTime? startDate = null, DateTime? endDate = null, PoloniexAccountActivityType? activityType = null, int? limit = null, long? from = null, PoloniexAccountActivityDirection? direction = null, string? asset = null, CancellationToken ct = default)
        {
            var parameters = new Parameters(PoloniexExchange._parameterSerializationSettings);
